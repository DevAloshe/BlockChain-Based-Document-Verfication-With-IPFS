...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
<!--     <a href="https://github.com/DevAloshe/BlockChain-Based-Documents-Verfication-System-With-IPFS/blob/main/README.md"><strong>Explore the docs »</strong></a> -->
    <br />
    <br />
...
3. Inside the project folder install NPM packages
   ...
   npm install
   ```
4. Copy the Solidity Contract located in the `Contract` folder and deploy it via Remix-Online-IDE , makesure you are upload the contract on any test network
   
5. Then  get the contract address and contract abi from Remix-Online-Ide and place it in the `app.js`
    ```js
    window.CONTRACT = {
